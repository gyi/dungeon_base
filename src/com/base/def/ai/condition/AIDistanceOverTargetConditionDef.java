 ...
 * @author : sunhua
 * @Description : 超过指定距离条件(心跳)
 */
@Describle("ai与目标距离超过指定值条件 ")
public class AIDistanceOverTargetConditionDef extends AIConditionDef {
	...
	public AIConditionType getAIConditionType() {
		return AIConditionType.DISTANCE_OVER;
	}
}
